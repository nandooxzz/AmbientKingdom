...
import { poppins,exo, roboto } from "@/fonts"
...
export default function ContactPage () {
    return (
        <section className="p-[100px] flex-col items-center">
            <div className="flex justify-around items-center contactDiv">
                <div className="contactTextDiv">
                    ...
                    <p className={`${roboto.className} text-zinc-700 w-[60%]`}>
                ...
                <div className="flex justify-center items-center "> {/* border-purple-500 border-2 rounded-md p-2 contactImageDiv */}
                    <Image src={"/blackink.png"} width={300} height={150} alt="Ambient Kingdom Logo" className="rounded-md"/>
                </div>
            </div>
            <br /><br /><br /><br />
